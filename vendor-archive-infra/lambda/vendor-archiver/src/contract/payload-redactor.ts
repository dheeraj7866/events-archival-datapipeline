 ...
 * payloads. Strategy (applied in order):
 *   1. Key-name matching — normalises camelCase/snake_case/kebab-case and checks
 *      against known PII field name sets.
 *   2. Value-pattern fallback — regex patterns catch Indian mobile numbers, PAN,
 *      email, and 12-digit Aadhaar sequences for unexpectedly-named fields.
 */
